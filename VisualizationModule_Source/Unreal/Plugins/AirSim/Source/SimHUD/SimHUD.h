...
public:
    ...
    void inputEventSelectVehicle0();
    void inputEventSelectVehicle1();
    void inputEventSelectVehicle2();
    void inputEventSelectVehicle3();
    void inputEventSelectVehicle4();
...
private:
    ...
    static FString getProjectPath(const std::string& filename);
    static FString getExecutableConfigPath(const std::string& filename);
