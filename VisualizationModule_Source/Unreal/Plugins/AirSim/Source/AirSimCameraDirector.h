...
private:
    ...
    void syncToPossessedPawn();
    void attachSpringArm(bool attach);
    void updateSpringArmChase(float DeltaSeconds);
    void resetSpringArmOrbit();
    void switchVehicleByIndex(int vehicle_index);
...
private:
    ...
    bool spring_arm_drag_active_ = false;
    bool spring_arm_orbit_initialized_ = false;
    float spring_arm_orbit_yaw_deg_ = 0.0f;
    float spring_arm_orbit_pitch_deg_ = -18.0f;
    float spring_arm_orbit_yaw_speed_deg_per_px_ = 0.20f;
    float spring_arm_orbit_pitch_speed_deg_per_px_ = 0.18f;
    float spring_arm_orbit_pitch_min_deg_ = -80.0f;
    float spring_arm_orbit_pitch_max_deg_ = 25.0f;
    float spring_arm_zoom_step_cm_ = 80.0f;
    float spring_arm_zoom_min_cm_ = 500.0f;
    float spring_arm_zoom_max_cm_ = 3000.0f;
};
