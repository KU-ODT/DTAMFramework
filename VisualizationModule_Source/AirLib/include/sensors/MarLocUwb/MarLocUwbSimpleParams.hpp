...
#ifndef msr_airlib_MarLocUwbSimpleParams_hpp
#define msr_airlib_MarLocUwbSimpleParams_hpp
...
struct MarLocUwbSimpleParams {
    ...
    void initializeFromSettings(const AirSimSettings::MarLocUwbSetting& settings)
    {
