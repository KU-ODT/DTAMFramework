"""WebSocket endpoint for DTAM module communication (/ws/dtam).
"""
...
from IntegrationHub.CoreServerModule.app.model.message import FORWARD_RULES, MODULE_ROLES
    ...
    try:
        while True:
            ...
            if msg_type == "message":
                ...
                if not hub.should_accept_message(mid, payload):
                    continue
