...
_DTAM_SDK_ROOT = _FRAMEWORK_ROOT / "DTAM_SDK"
if _DTAM_SDK_ROOT.is_dir() and str(_DTAM_SDK_ROOT) not in sys.path:
    sys.path.insert(0, str(_DTAM_SDK_ROOT))
...
PHASE_INFO: Dict[int, Dict[str, str]] = {
    ...
    7: {"name": "운용자 제어",           "name_en": "Operator Control",    "description": "수동 조종 입력(5001), 카메라 제어 명령(5002) → 해당 모듈 전달"},
}
