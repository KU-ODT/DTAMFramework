"""ODT mission replay pose-frame adapter.

This mirrors the pure coordinate/yaw parts of ``odt_mp.app.simulator_service``:
simpleDynamics WGS84 trajectory -> ODT custom Unreal frame -> AirSim pose.
"""
...
def _find_framework_root() -> Path:
    ...
    for parent in here.parents:
        if (parent / "DTAMVisualization").exists() and (parent / "DTAMAirMobility").exists():
            return parent
...
_VM_CONFIG_PATH = _FRAMEWORK_ROOT / "DTAMVisualization" / "vm_config.json"
