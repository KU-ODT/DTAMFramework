"""
Mission Dispatch System - MAVLink multi-aircraft telemetry receiver.
...
from .models import ActuatorData, AircraftStatus, AttitudeData, PositionData
...
class MavlinkMultiReceiver:
    def __init__(self, port: int, sysid_to_id: dict[int, str], ws_manager: Any) -> None:
        self.port = port
...
async def start_mavlink_receiver(
    ...
    _receiver = MavlinkMultiReceiver(port, sysid_to_id, ws_manager)
