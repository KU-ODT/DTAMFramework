...
from ..simpleDynamics.core.flight_dynamics import DynamicsEngine
from ..simpleDynamics.core.flight_profile import build_kinematics
from ..simpleDynamics.core.path_builder import build_segment_profiles
from ..simpleDynamics.core.types import (
    FlightPlan,
...
class IntegratedAirMobilityService:
    ...
    def _heartbeat_loop(self) -> None:
        while not self._heartbeat_stop.is_set():
            try:
                ok = self.publisher.push_module_status(source="DTAMAirVehicle", status=1)
                with self._lock:
        ...
        while not self._stop_event.is_set():
            ...
            if control_mode != ControlMode.MISSION:
                ...
                with self._lock:
                    ...
                    self._sim_time_s += max(0.0, dt)
                    sim_t = self._sim_time_s
                self._run_manual_tick(dt, sim_t)
