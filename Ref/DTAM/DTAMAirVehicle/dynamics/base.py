...
class ManualVehicleConfig:
    ...
    max_lateral_speed_mps: float = 6.0
    max_vertical_speed_mps: float = 4.0
    max_yaw_rate_deg_s: float = 36.0
    velocity_tau_s: float = 0.55
    attitude_tau_s: float = 0.28
    input_rise_tau_s: float = 0.32
    input_release_tau_s: float = 0.18
    yaw_input_tau_s: float = 0.42
    visual_tilt_max_deg: float = 18.0
