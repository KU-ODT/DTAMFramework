...
pip install -r DTAMAirVehicle/requirements.txt
```

### 2. 실행

```bash
python DTAMAirVehicle/AM_main.py
```
...
python DTAMAirVehicle/AM_main.py \
    ...
    --plan ./DTAMAirVehicle/simpleDynamics/example_mission.json \
...
from DTAMAirVehicle import IntegratedAirMobilityService, ClockMode
