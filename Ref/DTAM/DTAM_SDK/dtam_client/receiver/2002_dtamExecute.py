...
class ReceiveResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "simModeFileName": self.sim_mode_file_name,
            "simulationSetupFileName": self.simulation_setup_file_name,
            "scenarioFileName": self.scenario_file_name,
            "flightPlanFolderName": self.flight_plan_folder_name,
            "errors": self.errors,
        }
...
def parse(data: Union[bytes, str, Dict[str, Any]]) -> ReceiveResult:
    ...
    try:
        ...
        result.sim_mode_file_name = obj.get("simModeFileName")
        result.simulation_setup_file_name = obj.get("simulationSetupFileName")
        result.scenario_file_name = obj.get("scenarioFileName")
        result.flight_plan_folder_name = obj.get("flightPlanFolderName")
        return result
