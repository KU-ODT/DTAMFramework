...
- When `planVersion` increases, it is appropriate to keep only the latest version active in the Database and mark previous versions as inactive or superseded.
