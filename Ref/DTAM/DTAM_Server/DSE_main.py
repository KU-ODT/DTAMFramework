...
기본 동작:
 ...
 - sequence_diagram.json 규칙에 따라 Database 저장 + 타 모듈로 포워딩
...
사용 예::
    ...
    python DSE_main.py --db-root D:/DTAM/Database
...
from DTAM_Server.app.config import (  # noqa: E402
    DEFAULT_CONFIG_FILE,
    DEFAULT_DB_ROOT,
    load_config,
)
from DTAM_Server.app.server import create_app  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", default=None, help="config.json 경로 (기본: DTAM_Server/config.json)")
    ...
    parser.add_argument("--db-root", default=None, help=f"Database 루트 폴더 (기본: {DEFAULT_DB_ROOT})")
...
def main() -> None:
    ...
    print(f"[DSE] Database root: {cfg.db_root}")
