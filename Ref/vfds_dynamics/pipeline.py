"""
VFDS Dynamics Dispatch System Pipeline
...
from .dispatcher.models import DispatchResult, DispatchStatus
...
class MissionPipeline:
    ...
    def __init__(
        ...
        self._vfds_host = self._detect_local_ip()
    ...
    def cleanup_remote_host(self, target):
        ...
        patterns = [
            ...
            "vfds",
            "mavsdk_server",
            "vfds_dynamics_mavlink_forwarder_14550",
        ]
