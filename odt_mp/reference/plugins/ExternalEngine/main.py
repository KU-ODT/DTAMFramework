...
if __package__ in (None, ""):
    ...
    from reference.plugins.ExternalEngine import create_external_engine_dashboard
else:
    from . import create_external_engine_dashboard


def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Launch the ODT External Engine dashboard.")
...
def main() -> int:
    ...
    window = create_external_engine_dashboard(
