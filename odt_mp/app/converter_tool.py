...
from app.airsim.coord_transform import wgs84_to_local_ned

DEFAULT_AIRSIM_SETTINGS_PATH = Path.home() / "Documents" / "AirSim" / "settings.json"
ROOT_DIR = Path(__file__).resolve().parents[1]
DEFAULT_VERTIPORT_UE_PATH = ROOT_DIR / "data" / "vertiport_UE.csv"
DEFAULT_VERTIPORT_LAYOUT_PATH = ROOT_DIR / "data" / "groundmaps" / "Vertiport_round_KU_layout.csv"
