...
MODULES: list[ModuleCard] = [
    ...
    ModuleCard(
        ...
        description="Open the DTAM Server Emulator GUI directly for data feeds, logs, and server-side inspection.",
        icon="data",
        accent="#b8e86d",
...
MODULE_OVERVIEWS: dict[str, ModuleOverview] = {
    ...
    "plugin": ModuleOverview(
        slug="plugin",
        headline="Plug-In",
        summary="Reserve horizontally scalable runtime slots for operator plug-ins such as PSU, UAO, and VPO. The first release keeps the shell ready and leaves runtime launch hooks for later integration.",
        ...
        actions=[
            ...
            ActionItem(id="uao-slot", label="UAO", description="Reserved slot for the UAO plug-in runtime."),
