/* app.js — DTAM Mission Planner bootstrap */
...
(async function () {
  ...
  map.once('load', () => {
    ODT.Mission.init();
    ODT.Simulator?.init();              // = DTAM sender UI
    ODT.Converter?.init();
  ...
  if (connectBtn) {
    connectBtn.addEventListener('click', async () => {
      await ODT.Simulator?.refreshStatus?.(false);
    });
  }
  ...
  console.log('[DTAM Mission Planner] Initialized');
})();
