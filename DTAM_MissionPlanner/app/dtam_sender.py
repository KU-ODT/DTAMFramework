...
def _result_raw(result: Any) -> Dict[str, Any]:
    """수신 콜백 인자를 dict 으로 정규화 (DtamModule 은 dict, 구버전은 ReceiveResult)."""
...
class DtamSender:
    ...
    def __init__(
        ...
        *,
        ...
        target_port: int = 17000,        # legacy UDP — 미사용 (호환 유지)
        my_ip: str = "0.0.0.0",          # legacy bind  — 미사용
        my_port: int = 17010,            # legacy UDP   — 미사용
    ...
    def reconfigure(
        ...
        *,
        ...
        """WS 서버 endpoint 재설정. legacy UDP 인자도 받지만 무시."""
        with self._lock:
            rebuild = False
    ...
    def describe(self) -> Dict[str, Any]:
        with self._lock:
            ...
            return {
                ...
                "target_tcp_port": self._target_port + 1,  # legacy 표기 호환
                "my_ip": self._my_ip,
