...
class MonitoringService(MonitoringModule):
    ...
    def on_vehicle_status(self, msg) -> None:
        from app.services.vehicle_status_service import record_vehicle_status

        record_vehicle_status(msg)

    def on_vehicle_collision_event(self, msg) -> None:
        from app.services.vehicle_status_service import record_collision_event

        record_collision_event(msg)
