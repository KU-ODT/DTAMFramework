...
from .core.types import DEFAULT_SIMULATION_TICK_S, SimulationConfig
...
def main() -> None:
    ...
    parser.add_argument(
        "--tick",
        type=float,
        default=DEFAULT_SIMULATION_TICK_S,
        help=f"Simulation tick interval in seconds (default: {DEFAULT_SIMULATION_TICK_S:.6f})",
    )
    parser.add_argument(
        "--wind",
