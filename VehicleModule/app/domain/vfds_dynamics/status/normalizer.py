...
class TelemetryNormalizer:
    ...
    def normalize_4001(aircraft_id: str, vehicle_data: dict[str, Any], timestamp: str) -> dict[str, Any]:
        ...
        return {
            ...
            "velocityNed": {
                "north": float(gps_raw.get("velocity_north", 0.0)),
                "east": float(gps_raw.get("velocity_east", 0.0)),
                "down": float(gps_raw.get("velocity_down", 0.0)),
            },
            "actuator": {
