...
from DTAM_ServerEmulator.app.config import (  # noqa: E402
    DEFAULT_CONFIG_FILE,
    DEFAULT_DB_ROOT,
    load_config,
)
from DTAM_ServerEmulator.app.server import create_app  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", default=None, help="config.json 경로 (기본: DTAM_ServerEmulator/config.json)")
